...
export function getPhonicsForReading(reading) {
  ...
  const phonicsMap = {
    a: { upper: 'A', lower: 'a', sound: '/æ/ (애)', ttsSound: 'aeh', example: 'animal', exampleKo: '동물' },
    ...
    e: { upper: 'E', lower: 'e', sound: '/e/ (에)', ttsSound: 'eh', example: 'egg', exampleKo: '달걀' },
    f: { upper: 'F', lower: 'f', sound: '/f/ (프)', ttsSound: 'fuh', example: 'food', exampleKo: '음식' },
    g: { upper: 'G', lower: 'g', sound: '/g/ (그)', ttsSound: 'guh', example: 'go', exampleKo: '가다' },
    h: { upper: 'H', lower: 'h', sound: '/h/ (흐)', ttsSound: 'huh', example: 'help', exampleKo: '돕다' },
    ...
    l: { upper: 'L', lower: 'l', sound: '/l/ (ㄹ)', ttsSound: 'luh', example: 'lake', exampleKo: '호수' },
    m: { upper: 'M', lower: 'm', sound: '/m/ (음)', ttsSound: 'muh', example: 'move', exampleKo: '움직이다' },
    n: { upper: 'N', lower: 'n', sound: '/n/ (은)', ttsSound: 'nuh', example: 'need', exampleKo: '필요하다' },
    o: { upper: 'O', lower: 'o', sound: '/ɒ/ (오)', ttsSound: 'ah', example: 'on', exampleKo: '위에' },
    ...
    r: { upper: 'R', lower: 'r', sound: '/r/ (르)', ttsSound: 'ruh', example: 'river', exampleKo: '강' },
    s: { upper: 'S', lower: 's', sound: '/s/ (스)', ttsSound: 'suh', example: 'sea', exampleKo: '바다' },
    ...
    v: { upper: 'V', lower: 'v', sound: '/v/ (브)', ttsSound: 'vuh', example: 'very', exampleKo: '매우' },
    w: { upper: 'W', lower: 'w', sound: '/w/ (우)', ttsSound: 'wuh', example: 'wind', exampleKo: '바람' },
    x: { upper: 'X', lower: 'x', sound: '/ks/ (크스)', ttsSound: 'eks', example: 'box', exampleKo: '상자' },
    y: { upper: 'Y', lower: 'y', sound: '/j/ (이)', ttsSound: 'yuh', example: 'yes', exampleKo: '네' },
    z: { upper: 'Z', lower: 'z', sound: '/z/ (즈)', ttsSound: 'zuh', example: 'zoo', exampleKo: '동물원' },
  };
